...
<body>
	...
	<fieldset>
	<legend style="font-size:35px;">Add sign up details</legend>
	...
	<input type = "submit" value="Register" style="text-align: center; padding: 8px 16px; font-size: 100%; display: inline-block;">
