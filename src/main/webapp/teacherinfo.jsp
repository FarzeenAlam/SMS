...
<body>
	...
	<form action="teacheradded" method="post">
	...
	<input type = "number" name="Salary" required style="padding: 8px 32px;"><br><br>
	
	<label style="font-size:20px;">Enter department id:</label><br>
	<input type = "number" name="department" required style="padding: 8px 32px;">
	<br><br>
	
	<label style="font-size:20px;">Enter course no. 1:</label><br>
	<input type = "number" name="course" required style="padding: 8px 32px;">
	<br><br>
	
	<label style="font-size:20px;">Enter course no. 2:</label><br>
	<input type = "number" name="course" required style="padding: 8px 32px;">
	<br><br>
	
	<label style="font-size:20px;">Enter student:</label><br>
	<input type = "number" name="student" required style="padding: 8px 32px;">
	<br><br>
